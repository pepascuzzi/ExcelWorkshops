---
title: "Data Organization with Excel 1"
...
This is the first part of a two part workshop.  Download the files from GitHub, [external link](https://github.com/pepascuzzi/ExcelWorkshops).  
...
Within rectangular data sets, there are two common formats, **wide** and **long**.  A third format named **tidy** is emerging with the increasing use of data science in all fields.  **Tidy** data is essentially a rigorous form of the **long** format that incorporates additional best practices in data management (Wickham, 2014), [external link](https://www.jstatsoft.org/article/view/v059i10){target="_blank"}.  
...
Excel is notorious for corrupting data because of the assumptions that are made about your data type.  The General import method in Excel will often convert specific textual data to dates.  In addition, Excel will strip leading zeroes from numbers used as identifiers.  See this thread [external link](https://answers.microsoft.com/en-us/msoffice/forum/msoffice_excel-mso_windows8-mso_2013_release/microsoft-excel-corrupts-data-in-csv-files/8337e85c-b1f5-4e99-9ca4-1ab51ae2984e?auth=1){target="_blank"} on the Microsoft forum about related issues.  
...
9. Locate the file **exampleGradeBookTAB.txt**.  Double-click on it.  It should open with NotePad or WordPad.  It should not open with Excel.  However, Excel can open this type of file.  Close NotePad/WordPad.  
...
2. In cells L5 through L8, enter the values "valid.class", "Freshman", "Sophomore", "Junior", and "Senior".  This small list will be used by Data Validation.  
...
+ Excel Functions, [external link](https://support.office.com/en-us/article/Excel-functions-alphabetical-b3944572-255d-4efb-bb96-c6d90033e188){target="_blank"}. An alphabetical list of available functions for Excel with some information on how to use them.  
+ Excel Cheatsheet, [external link](http://www.collegedegreesearch.net/excel-cheats/){target="_blank"} - Not comprehensive but a nice cheatsheet for common tasks.  
+ Disadvantages of Spreadsheets, [external link](https://www.denizon.com/spreadsheets/top-10-disadvantages-of-spreadsheets/){target="_blank"} - There are likely dozens of documents like this.  Simply put, spreadsheets must used with caution.  They should never be used as the sole format for your datasets!  